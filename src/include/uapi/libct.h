...
extern int libct_container_spawn_execvr(ct_handler_t ct, char *path, char **argv, int *fds);
extern int libct_container_spawn_execver(ct_handler_t ct, char *path, char **argv, char **env, int *fds);
